...
3. **Assistant Connectivity (MCP)** — Connect Claude, ChatGPT, or any MCP client to manage tasks conversationally. 92 tools across capture, planning, review, and automation.
