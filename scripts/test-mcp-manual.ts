...
const API_BASE = "http://localhost:4000"; // Server runs on 4000 by default configured in the app maybe? Actually, default is 3000 but I'll check config. Wait, let's use process.env.PORT or 3000. Express config earlier had PORT.
// Let's rely on standard 3000.
